        ...
        <tbody>
            @forelse ($issues as $issue)
                <tr data-bs-toggle="modal" data-bs-target="#issueModal{{ $issue['number'] }}">
                    ...
                    <td hidden>{{ $issue['repository']['name'] }}</td>
                    <td>{{ $issue['title'] }}</td>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p><strong>Repository Name:</strong> {{ $issue['repository']['name'] }}</p>
                    <p style="overflow: hidden;text-overflow: ellipsis;"><strong>Description:</strong>
                        <textarea name="description" id="description" disabled style="width:100%" rows="5">{{ ($issue['body']) ?? 'No description available.' }}</textarea>
